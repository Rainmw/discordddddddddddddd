...
global.icon = `https://cdn.discordapp.com/attachments/580969388170018820/594831200540164107/SANTOSLOGO1.png`;
...
var role = member.guild.roles.find(x => x.name === "Kayıtsız Üye"); // Variable to get channel ID
